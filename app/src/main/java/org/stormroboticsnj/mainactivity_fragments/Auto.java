...
public class Auto extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TextView outerScoreTxt = view.findViewById(R.id.txtPCA2); // TextView outer port score
        final TextView innerScoreTxt = view.findViewById(R.id.txtPCA3); // TextView inner port score
