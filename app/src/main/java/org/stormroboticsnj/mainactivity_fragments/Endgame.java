...
public class Endgame extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TextView txtScoredLVL2 = view.findViewById(R.id.txtPCE2); // Text View for number of power cells scored in outer port
        final TextView txtScoredLVL3 = view.findViewById(R.id.txtPCE3); // Text View for number of power cells scored in inner port

        // Radio buttons in a radio group
        final RadioButton park = view.findViewById(R.id.rdoPark); // Radio button for parking
        final RadioButton hang = view.findViewById(R.id.rdoHang); // Radio button for hanging
        final RadioButton levelHang = view.findViewById(R.id.rdoLevelHang); // Radio button for Level Hang
        final RadioButton none = view.findViewById(R.id.rdoNone); // Radio button for "none of the above actions"
